        ...
        <Container>
          <Row>
            ...
            <p>
              ...
              JavaScript, Python, Node.js, React, and MongoDB. Demonstrated
          ...
          <Row>
            ...
            <Container>
              ...
              <ul>
                ...
                <li>
                  ~ Wrote SQL queries using JavaScript in Adobe Campaign Classic
                  Supported marketers in HTML Email development.
                </li>
                <li>
                ...
                <li>
                  ...
                  dashboard, which allows end users to proactivly monitor their
                  instance and get on top of issues before they occur. this
                  dashboard also enables marketers to view deliverability and
                  engagement metrics without having to acces the adobe campaign
                  classic console
                </li>
                <li>
                  ~ Provided documentation of design and development of Projects
                </li>
              </ul>
            </Container>
          </Row>
